...
Usage:
    python scripts/analysis/analyze_cross_head_impact.py \
...
Examples:
    ...
    python scripts/analysis/analyze_cross_head_impact.py --campaign-id ablation_12345

    # Use validation split instead of test
    python scripts/analysis/analyze_cross_head_impact.py --campaign-id ablation_12345 --split val
