...
Usage:
    python scripts/analysis/analyze_loss_curve.py <path_to_events_dir>
    python scripts/analysis/analyze_loss_curve.py <experiment_name> --text
    python scripts/analysis/analyze_loss_curve.py <path> --diagnose
"""
