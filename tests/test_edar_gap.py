...
def test_edar_processor_marks_gap_as_stale(
    ...
    try:
        ...
        mask = result.edar_biomarker_N1_mask.sel(
            run_id="real", date="2022-01-02", region_id="REG1"
        ).values
        age = result.edar_biomarker_N1_age.sel(
            run_id="real", date="2022-01-02", region_id="REG1"
        ).values
        ...
        assert (
            result.edar_biomarker_N1_mask.sel(
                run_id="real", date="2022-01-01", region_id="REG1"
            ).values
            == 1.0
        )
        assert (
            result.edar_biomarker_N1_mask.sel(
                run_id="real", date="2022-01-03", region_id="REG1"
            ).values
            == 1.0
        )
    finally:
